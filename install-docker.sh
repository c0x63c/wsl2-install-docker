...
sudo apt update && sudo apt -y install ca-certificates aria2 gnupg
sudo mkdir -p /etc/apt/keyrings
aria2c -q https://download.docker.com/linux/ubuntu/gpg -o | sudo gpg --dearmor -o /etc/apt/keyrings/docker.gpg
